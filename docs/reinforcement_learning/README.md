...
<div style="display: flex; justify-content: space-between; align-items: center; margin-top: 40px; padding-top: 20px; border-top: 1px solid var(--line, #232b3b);">
  <div><a href="../localization/" style="color: var(--accent, #38bdf8); text-decoration: none; font-weight: 600;">← Previous Axon: Localization & State Estimation</a></div>
  <div><a href="../" style="color: var(--muted, #94a3b8); text-decoration: none;">Curriculum Home</a></div>
  <div><a href="../math/" style="color: var(--accent, #38bdf8); text-decoration: none; font-weight: 600;">Restart Track: Math Foundations ↺</a></div>
</div>
