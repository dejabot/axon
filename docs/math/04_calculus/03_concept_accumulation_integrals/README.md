...
<div style="display: flex; justify-content: space-between; align-items: center; margin-top: 40px; padding-top: 20px; border-top: 1px solid var(--line, #232b3b);">
  ...
  <div><a href="../04_concept_gradients_multivariable/" style="color: var(--accent, #38bdf8); text-decoration: none; font-weight: 600;">Concept 15: Gradients & Optimization →</a></div>
</div>
