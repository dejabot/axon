...
$$
\operatorname{cross}(u, v) = u_x \cdot v_y - u_y \cdot v_x
$$
...
$$
A + t \cdot r = C + u \cdot s \qquad \text{where } r = B - A \text{ and } s = D - C
$$
...
$$
\begin{aligned}
\operatorname{cross}(A + t \cdot r, s) &= \operatorname{cross}(C + u \cdot s, s) \\
\operatorname{cross}(A, s) + t \cdot \operatorname{cross}(r, s) &= \operatorname{cross}(C, s) + 0 \\
t \cdot \operatorname{cross}(r, s) &= \operatorname{cross}(C - A, s)
\end{aligned}
$$
...
$$
\begin{aligned}
t &= \frac{\operatorname{cross}(C - A, s)}{\operatorname{cross}(r, s)} \\[4pt]
u &= \frac{\operatorname{cross}(C - A, r)}{\operatorname{cross}(r, s)}
\end{aligned}
$$
...
$$
\text{distanceToLine} = \frac{\lvert \operatorname{cross}(B - A, P - A) \rvert}{\lvert B - A \rvert}
$$
...
$$
t = \frac{(P - A)_x \cdot r_x + (P - A)_y \cdot r_y}{r_x^2 + r_y^2}
$$
