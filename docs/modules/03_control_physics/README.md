...
4. **State-Space Representation & LQR Optimal Control:** Continuous and discrete state vectors, system matrices (A, B, C, D), and optimal Linear Quadratic Regulator (LQR) cost minimization.
