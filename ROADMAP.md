...
* **Concept 01: Vectors, Basis Spaces & Matrix Transformations**
  ...
  * *Scope:* Basis vectors (`î`, `ĵ`), linear transformations, determinants (area scaling & singularity), eigenvectors/eigenvalues, dot product projections.
  * *Forward Link:* Concepts 05 (Dense layers), 13 (Swerve kinematics), and 15 (Vision PnP).
* **Concept 02: Trigonometry, atan2 & Continuous Angle Topology**
  ...
  * *Forward Link:* Concepts 10 (Arm feedforward), 13 (Swerve angle optimization), and 16 (EKF heading).
* **Concept 03: Single-Variable Motion Calculus & Jerk**
  ...
  * *Forward Link:* Concepts 05 (Loss landscapes), 10 (Acceleration feedforward), and 14 (2nd-order skew).
* **Concept 04: Multivariable Calculus, Gradients & The Chain Rule**
  ...
  * *Forward Link:* Concepts 05 (Gradient descent), 07 (Backpropagation), and 18 (Policy gradients).
...
* **Concept 05: Loss Landscapes & Optimization Algorithms**
  ...
  * *Backward Link:* Concept 04 (Gradients).
* **Concept 06: Dense Layers & Non-Linear Activation Functions**
  ...
  * *Backward Link:* Concept 01 (Matrix transformations).
* **Concept 07: Vector Calculus Backpropagation & Computation Graphs**
  ...
  * *Backward Link:* Concepts 01 (Matrices) and 04 (Chain rule).
* **Concept 08: In-Browser 2D Neural Classifier Sandbox**
  ...
  * *Backward Link:* Concepts 05, 06, and 07.
...
* **Concept 09: DC Motor Electromechanics & Torque-Speed Curves**
  ...
  * *Forward Link:* Concept 10 (Feedforward).
* **Concept 10: Modern Feedforward Modeling (kS, kV, kA, kG)**
  ...
  * *Backward Link:* Concepts 02 (Cosine gravity) and 03 (Acceleration derivatives).
* **Concept 11: Feedback PID Control & Anti-Windup**
  ...
  * *Backward Link:* Concept 03 (Integration & differentiation).
* **Concept 12: State-Space Representation & LQR Optimal Control**
  ...
  * *Backward Link:* Concept 01 (State vectors and matrices).
...
* **Concept 13: 4-Wheel Swerve Kinematics & Vector Decomposition**
  ...
  * *Backward Link:* Concepts 01 (Vector addition) and 02 (`atan2` angle calculation).
* **Concept 14: Module Optimization & 2nd-Order Skew Correction**
  ...
  * *Backward Link:* Concepts 01 (Rotation matrices) and 02 (Angle optimization).
* **Concept 15: Computer Vision & AprilTag Perspective-n-Point (PnP)**
  ...
  * *Backward Link:* Concept 01 (Homogeneous transformations).
* **Concept 16: Extended Kalman Filter (EKF) Sensor Fusion**
  ...
  * *Backward Link:* Concepts 01 (Matrix algebra), 03 (Integration), and 12 (State estimation).
...
* **Concept 18: Policy Gradients & Deep RL (PPO)**
  ...
  * *Backward Link:* Concepts 04 (Gradients) and 07 (Backpropagation).
...
* **Concept 21: Dynamic Obstacle Avoidance & Path Planning**
  ...
  * *Backward Link:* Concepts 01 (Vectors) and 13 (Swerve execution).
...
* **Concept 24: System Identification & Real-World Calibration**
  ...
  * *Backward Link:* Concepts 04 (Optimization) and 09 (Motor physics).
